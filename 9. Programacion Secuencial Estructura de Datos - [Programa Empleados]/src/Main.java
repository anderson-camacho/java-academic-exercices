 ...
 * programacion con condicionales IF and SWITCH con ciclos y ademas elementos de
...
public class Main {
	...
	// d3eclaracion
	String listaEmpleados[] = new String[1];
	...
	public void nuevoEmpleado() {
		String nuevaListaEmpleados[] = new String[this.listaEmpleados.length + 1];
		System.arraycopy(this.listaEmpleados, 0, nuevaListaEmpleados, 0, listaEmpleados.length);
		this.listaEmpleados = nuevaListaEmpleados;
	}
